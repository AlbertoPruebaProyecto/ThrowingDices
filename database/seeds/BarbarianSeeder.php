...
class BarbarianSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('special_aptitudes')->insert([
    		...
    		<br><br>Aplica este bonificador antes de modificar la velocidad del bárbaro a causa de cualquier carga transportada o armadura puesta, bonificador que se apila con cualquier otro a su velocidad terrestre.',
    		'class_id'      =>  DB::table('classes')->where('name', 'barbarian')->value('id'),
    	]);
