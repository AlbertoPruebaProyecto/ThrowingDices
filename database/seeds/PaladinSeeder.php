...
class PaladinSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('special_aptitudes')->insert([
    		...
    		<br><br>Para preparar o lanzar un conjuro, un paladín debe tener una puntuación de Carisma igual a por lo menos 10 + el nivel del conjuro. La Clase de dificultad para una tirada de salvación contra un conjuro de paladín es 10 + el nivel del conjuro + el modificador de Carisma del paladín.
    		<br><br>Como otros lanzadores de conjuros, un paladín sólo puede lanzar cierto número de conjuros de cada nivel al día. Su asignación básica diaria de conjuros se refleja en la tabla 3-11. Además, obtiene conjuros adicionales al día si tiene una puntuación de Carisma elevada (consulta la tabla 1-3). Cuando la tabla 3-11 indica que el paladín obtiene 0 conjuros al día de un nivel de conjuro determinado, sólo obtiene los conjuros adicionales a los que tendría derecho basándose en su puntuación de Carisma para dicho nivel de conjuro.
    		<br><br>Un paladín debe pasar 1 hora diaria en oración tranquila y meditación, para recuperar su asignación diaria de conjuros. El paladín puede preparar y lanzar cualquier conjuro de la lista de conjuros de paladín, en tanto en cuanto pueda lanzar conjuros de dicho nivel, pero debe escoger qué conjuros preparar durante su meditación diaria.
    		<br><br>Hasta 3er nivel, un paladín no tiene nivel de lanzador. A 4º nivel y superiores, su nivel de lanzador es igual a su nivel de paladín -3.',
    		'class_id'      =>  DB::table('classes')->where('name', 'paladin')->value('id'),
    	]);
    	DB::table('special_aptitudes')->insert([
    		'name'          =>  'Vínculo divino',
