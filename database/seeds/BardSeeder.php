...
class BardSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('special_aptitudes')->insert([
    		...
    		<br><br>Lanzar una sugestión no cuenta para el número de usos diarios de la interpretación de bardo. Una tirada de salvación (CD 10 + la mitad del nivel del bardo + su modificador de Car) niega el efecto. Esta aptitud afecta a una sola criatura. Sugestión es una aptitud enajenadora de encantamiento (compulsión) dependiente del idioma, y se basa en componentes auditivos.',
    		'class_id'      =>  DB::table('classes')->where('name', 'bard')->value('id'),
    	]);
    	DB::table('special_aptitudes')->insert([
